...
internal sealed class EditorTests : BUnitTestContext
{
    ...
    public void TestId()
    {
        ...
        editor.MarkupMatches("""<input id="fake-id" type="text" />""");
    }
    ...
    public void TestType()
    {
        ...
        multiLineEditor.MarkupMatches("""<textarea />""");

        var numberEditor = RenderComponent<Editor<int>>();
        numberEditor.MarkupMatches("""<input type="number" />""");

        var textEditor = RenderComponent<Editor<string>>();
        textEditor.MarkupMatches("""<input type="text" />""");
    }
    ...
    public void TestValue()
    {
        ...
        editor.MarkupMatches("""<input type="text" value="fake-value" />""");
    }
    ...
    public void TestValueExpression()
    {
        ...
        editor.MarkupMatches("""<input type="number" min="0" max="42" value="37" />""");
    }
